...
export default function CompilarRemPPage() {
  ...
  const handleCompile = async () => {
    ...
    setCompiling(true);
    try {
      const res = await fetch(API + "CompilarREMP", {
        method: "POST",
      ...
      a.href = url;
      a.download = selectedEstablishment + "P" + selectedMonth.toString().padStart(2, "0") + "-compilado.xlsm";
      a.click();
      setCompiling(false);
    } catch (err: any) {
  ...
  return (
    <main className="flex-1 p-6 sm:p-10">
      <div style={{ maxWidth: 640, margin: "0 auto" }}>
        <Breadcrumbs items={[{ label: "Operación REM" }, { label: "Compilar REM Serie P" }]} />
        <h1 className="text-2xl font-bold mb-1" style={{ color: "var(--text)" }}>
          Compilar REM Serie P
        </h1>
        <p className="text-sm mb-5" style={{ color: "var(--text-light)" }}>
          Suba los archivos REM Serie P y compile la planilla consolidada.
        </p>
        ...
        >
          <ol className="list-decimal list-inside flex flex-col gap-1">
            ...
            <li>Suba los archivos Serie P correspondientes y asegúrese que la versión sea la correcta.</li>
          ...
          <p className="mt-2 font-semibold" style={{ color: "var(--text)" }}>
            VERSIÓN ACTUAL SERIE P: 1.2 Febrero 2026
          </p>
        </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 mb-4">
            <div className="flex-1">
              ...
              <input
                ...
                disabled={subiendo}
                aria-describedby="compilarp-name-hint"
              />
              <p id="compilarp-name-hint" className="text-xs mt-0.5" style={{ color: "var(--text-light)" }}>
            ...
            <div className="flex items-end">
              ...
              <input
                ...
                aria-label="Subir archivo REM Serie P .xlsm"
              />
            </div>
          </div>
        )}
        ...
        {canCompile && (
          ...
          >
            {compiling
              ...
              : <><Settings size={15} aria-hidden /> Compilar REM Serie P</>}
          </button>
        )}
